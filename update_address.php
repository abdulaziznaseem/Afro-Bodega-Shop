...
if(isset($_POST['submit'])){
   ...
   $address = $_POST['flat'] .', '.$_POST['building'].', '.$_POST['area'].', '.$_POST['town'] .', '. $_POST['city'] .', '. $_POST['landmark'] .', '. $_POST['country'] .' - '. $_POST['pin_code'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>your address</h3>
      <input type="text" class="box" placeholder="Telephone" required maxlength="50" name="flat">
      ...
      <input type="text" class="box" placeholder="nearest landmark" required maxlength="50" name="landmark">
